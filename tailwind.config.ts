	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'glow-bg': 'radial-gradient(circle at center, rgba(155,135,245,0.15) 0%, transparent 70%)',
				'shimmer': 'linear-gradient(90deg, transparent, rgba(155,135,245,0.2), transparent)',
			},
		}
	},
